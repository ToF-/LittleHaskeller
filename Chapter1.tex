...
9c Ah \spades{K} \diamonds{K} \diamonds{9} \clubs{3} \diamonds{6}
Ac Qc \spades{K} \diamonds{K} \diamonds{9} \clubs{3}
\hearts{9} \spades{5}
4d 2d \spades{K} \diamonds{K} \diamonds{9} \clubs{3} \diamonds{6}
7s Ts \spades{K} \diamonds{K} \diamonds{9}
\end{alltt}
\hspace*{\fill} 
...
9c Ah \spades{K} \diamonds{K} \diamonds{9} \clubs{3} \diamonds{6} Two Pair
Ac Qc \spades{K} \diamonds{K} \diamonds{9} \clubs{3} 
\hearts{9} \spades{5} 
4d 2d \spades{K} \diamonds{K} \diamonds{9} \clubs{3} \diamonds{6} Flush
7s Ts \spades{K} \diamonds{K} \diamonds{9} 
\end{alltt}
\hspace*{\fill} 
\lhA I see. 
