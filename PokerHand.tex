...
\lstset{classoffset=0,
	...
	tabsize=4,
	tab=$\to$,
	literate={->}{$\to$ }2 {>=}{$\geq$}1 {==>}{$\Longrightarrow$}1 {lll}{$\lambda$}1 {[]}{[ ]}2 {__}{\space}1 
...
\maketitle
\troislambdas
\input{Chapter1}\input{Chapter2}\input{Chapter3}\input{Chapter4}\input{Chapter5}\input{Chapter6}\input{Chapter7}
\input{Chapter8}
\end{document}
